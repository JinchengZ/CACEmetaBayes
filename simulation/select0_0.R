...
select0_0_pD <- select0_0_DIC <- rep(NA, 4)
select0_0_CACE <- rep(NA, 37)
...
wrap=function(j)
{
  ...
  select0_0_CACE[1] <- probit(alpha_u, inverse=T) - probit(alpha_v, inverse=T)
  ...
  select0_0_pD[1] <- samps.m0$dic[[2]]
  select0_0_DIC[1] <- samps.m0$dic[[1]] + samps.m0$dic[[2]]
  
  select0_0_CACE[2] <- summary(samps.m0$samples)[[1]][1,1]  # mean CACE
  select0_0_CACE[3:5] <- c(summary(samps.m0$samples)[[2]][1,1], 
                           summary(samps.m0$samples)[[2]][1,3], 
                           summary(samps.m0$samples)[[2]][1,5])  # 2.5% 50% 97.5% CACE
  select0_0_CACE[6] <- ifelse((select0_0_CACE[3]<=select0_0_CACE[1]) & (select0_0_CACE[5]>=select0_0_CACE[1]), 1, 0)
  select0_0_CACE[7] <- select0_0_CACE[5] - select0_0_CACE[3]  # CACE length
  select0_0_CACE[8] <- (select0_0_CACE[2] - select0_0_CACE[1])/select0_0_CACE[1]  # relative bias
  select0_0_CACE[9] <- select0_0_CACE[2] - select0_0_CACE[1]  # bias
  select0_0_CACE[10] <- (select0_0_CACE[2] - select0_0_CACE[1])^2  # bias^2
  ...
  select0_0_pD[2] <- samps.m1$dic[[2]]
  select0_0_DIC[2] <- samps.m1$dic[[1]] + samps.m1$dic[[2]]
  
  select0_0_CACE[2+9] <- summary(samps.m1$samples)[[1]][1,1]  # mean CACE
  select0_0_CACE[(3+9):(5+9)] <- c(summary(samps.m1$samples)[[2]][1,1], 
                                   summary(samps.m1$samples)[[2]][1,3], 
                                   summary(samps.m1$samples)[[2]][1,5])  # 2.5% 50% 97.5% CACE
  select0_0_CACE[6+9] <- ifelse((select0_0_CACE[3+9]<=select0_0_CACE[1]) & (select0_0_CACE[5+9]>=select0_0_CACE[1]), 1, 0)
  select0_0_CACE[7+9] <- select0_0_CACE[5+9] - select0_0_CACE[3+9]  # CACE length
  select0_0_CACE[8+9] <- (select0_0_CACE[2+9] - select0_0_CACE[1])/select0_0_CACE[1]  # relative bias
  select0_0_CACE[9+9] <- select0_0_CACE[2+9] - select0_0_CACE[1]  # bias
  select0_0_CACE[10+9] <- (select0_0_CACE[2+9] - select0_0_CACE[1])^2  # bias^2
  ...
  select0_0_pD[3] <- samps.m2$dic[[2]]
  select0_0_DIC[3] <- samps.m2$dic[[1]] + samps.m2$dic[[2]]
  
  select0_0_CACE[2+9*2] <- summary(samps.m2$samples)[[1]][1,1]  # mean CACE
  select0_0_CACE[(3+9*2):(5+9*2)] <- c(summary(samps.m2$samples)[[2]][1,1], 
                                       summary(samps.m2$samples)[[2]][1,3], 
                                       summary(samps.m2$samples)[[2]][1,5])  # 2.5% 50% 97.5% CACE
  select0_0_CACE[6+9*2] <- ifelse((select0_0_CACE[3+9*2]<=select0_0_CACE[1]) & (select0_0_CACE[5+9*2]>=select0_0_CACE[1]), 1, 0)
  select0_0_CACE[7+9*2] <- select0_0_CACE[5+9*2] - select0_0_CACE[3+9*2]  # CACE length
  select0_0_CACE[8+9*2] <- (select0_0_CACE[2+9*2] - select0_0_CACE[1])/select0_0_CACE[1]  # relative bias
  select0_0_CACE[9+9*2] <- select0_0_CACE[2+9*2] - select0_0_CACE[1]  # bias
  select0_0_CACE[10+9*2] <- (select0_0_CACE[2+9*2] - select0_0_CACE[1])^2  # bias^2
  ...
  select0_0_pD[4] <- samps.m3$dic[[2]]
  select0_0_DIC[4] <- samps.m3$dic[[1]] + samps.m3$dic[[2]]
  
  select0_0_CACE[2+9*3] <- summary(samps.m3$samples)[[1]][1,1]  # mean CACE
  select0_0_CACE[(3+9*3):(5+9*3)] <- c(summary(samps.m3$samples)[[2]][1,1], 
                                       summary(samps.m3$samples)[[2]][1,3], 
                                       summary(samps.m3$samples)[[2]][1,5])  # 2.5% 50% 97.5% CACE
  select0_0_CACE[6+9*3] <- ifelse((select0_0_CACE[3+9*3]<=select0_0_CACE[1]) & (select0_0_CACE[5+9*3]>=select0_0_CACE[1]), 1, 0)
  select0_0_CACE[7+9*3] <- select0_0_CACE[5+9*3] - select0_0_CACE[3+9*3]  # CACE length
  select0_0_CACE[8+9*3] <- (select0_0_CACE[2+9*3] - select0_0_CACE[1])/select0_0_CACE[1]  # relative bias
  select0_0_CACE[9+9*3] <- select0_0_CACE[2+9*3] - select0_0_CACE[1]  # bias
  select0_0_CACE[10+9*3] <- (select0_0_CACE[2+9*3] - select0_0_CACE[1])^2  # bias^2
  
  write.table(select0_0_CACE, paste("sim_CACE/select0_0_CACE_", j, ".txt", sep=""), sep="\t")
  write.table(select0_0_pD, paste("sim_pD/select0_0_pD_", j, ".txt", sep=""), sep="\t")
  write.table(select0_0_DIC, paste("sim_DIC/select0_0_DIC_", j, ".txt", sep=""), sep="\t")

  output <- list(select0_0_pD, select0_0_DIC)
  return(output)
...
select0_0_DIC <- matrix(NA, R, 4)
select0_0_pD <- matrix(NA, R, 4)
select0_0_loc <- rep(NA, R)
select0_0_CACE <- matrix(NA, R, 37)
colnames(select0_0_CACE) <- 
...
for (i in 1:R){
  select0_0_DIC[i, ] <- read.table(paste("sim_DIC/select0_0_DIC_",i,".txt",sep=""))$x
  select0_0_loc[i] <- which.min(select0_0_DIC[i,])
  select0_0_pD[i, ] <- read.table(paste("sim_pD/select0_0_pD_",i,".txt",sep=""))$x
  
  select0_0_CACE[i, ] <- read.table(paste("sim_CACE/select0_0_CACE_",i,".txt",sep=""))$x
}

table0_0 <- matrix(NA, 1, 4)
for (i in 1:4) {
  table0_0[i] <- length(which(select0_0_loc == i)) 
}

selectCACE0_0 <- colMeans(select0_0_CACE)

# Save the data
write.table(table0_0, "simout/table0_0.txt", sep="\t", row.names = FALSE)
write.table(selectCACE0_0, "simout/selectCACE0_0.txt", sep="\t", row.names = FALSE)