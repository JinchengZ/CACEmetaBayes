...
select1_1_pD <- select1_1_DIC <- rep(NA, 4)
select1_1_CACE <- rep(NA, 37)
...
wrap=function(j)
{
  ...
  for (i in 1:I) {
    ...
    p0[i] <- expit(beta0 + beta1*logit(pi_c[i]))
  ...
  select1_1_CACE[1] <- probit(alpha_u, inverse=T) - probit(alpha_v, inverse=T)
  ...
  select1_1_pD[1] <- samps.m0$dic[[2]]
  select1_1_DIC[1] <- samps.m0$dic[[1]] + samps.m0$dic[[2]]
  
  select1_1_CACE[2] <- summary(samps.m0$samples)[[1]][1,1]  # mean CACE
  select1_1_CACE[3:5] <- c(summary(samps.m0$samples)[[2]][1,1], 
                           summary(samps.m0$samples)[[2]][1,3], 
                           summary(samps.m0$samples)[[2]][1,5])  # 2.5% 50% 97.5% CACE
  select1_1_CACE[6] <- ifelse((select1_1_CACE[3]<=select1_1_CACE[1]) & (select1_1_CACE[5]>=select1_1_CACE[1]), 1, 0)
  select1_1_CACE[7] <- select1_1_CACE[5] - select1_1_CACE[3]  # CACE length
  select1_1_CACE[8] <- (select1_1_CACE[2] - select1_1_CACE[1])/select1_1_CACE[1]  # relative bias
  select1_1_CACE[9] <- select1_1_CACE[2] - select1_1_CACE[1]  # bias
  select1_1_CACE[10] <- (select1_1_CACE[2] - select1_1_CACE[1])^2  # bias^2
  ...
  select1_1_pD[2] <- samps.m1$dic[[2]]
  select1_1_DIC[2] <- samps.m1$dic[[1]] + samps.m1$dic[[2]]
  
  select1_1_CACE[2+9] <- summary(samps.m1$samples)[[1]][1,1]  # mean CACE
  select1_1_CACE[(3+9):(5+9)] <- c(summary(samps.m1$samples)[[2]][1,1], 
                                   summary(samps.m1$samples)[[2]][1,3], 
                                   summary(samps.m1$samples)[[2]][1,5])  # 2.5% 50% 97.5% CACE
  select1_1_CACE[6+9] <- ifelse((select1_1_CACE[3+9]<=select1_1_CACE[1]) & (select1_1_CACE[5+9]>=select1_1_CACE[1]), 1, 0)
  select1_1_CACE[7+9] <- select1_1_CACE[5+9] - select1_1_CACE[3+9]  # CACE length
  select1_1_CACE[8+9] <- (select1_1_CACE[2+9] - select1_1_CACE[1])/select1_1_CACE[1]  # relative bias
  select1_1_CACE[9+9] <- select1_1_CACE[2+9] - select1_1_CACE[1]  # bias
  select1_1_CACE[10+9] <- (select1_1_CACE[2+9] - select1_1_CACE[1])^2  # bias^2
  ...
  select1_1_pD[3] <- samps.m2$dic[[2]]
  select1_1_DIC[3] <- samps.m2$dic[[1]] + samps.m2$dic[[2]]
  
  select1_1_CACE[2+9*2] <- summary(samps.m2$samples)[[1]][1,1]  # mean CACE
  select1_1_CACE[(3+9*2):(5+9*2)] <- c(summary(samps.m2$samples)[[2]][1,1], 
                                       summary(samps.m2$samples)[[2]][1,3], 
                                       summary(samps.m2$samples)[[2]][1,5])  # 2.5% 50% 97.5% CACE
  select1_1_CACE[6+9*2] <- ifelse((select1_1_CACE[3+9*2]<=select1_1_CACE[1]) & (select1_1_CACE[5+9*2]>=select1_1_CACE[1]), 1, 0)
  select1_1_CACE[7+9*2] <- select1_1_CACE[5+9*2] - select1_1_CACE[3+9*2]  # CACE length
  select1_1_CACE[8+9*2] <- (select1_1_CACE[2+9*2] - select1_1_CACE[1])/select1_1_CACE[1]  # relative bias
  select1_1_CACE[9+9*2] <- select1_1_CACE[2+9*2] - select1_1_CACE[1]  # bias
  select1_1_CACE[10+9*2] <- (select1_1_CACE[2+9*2] - select1_1_CACE[1])^2  # bias^2
  ...
  select1_1_pD[4] <- samps.m3$dic[[2]]
  select1_1_DIC[4] <- samps.m3$dic[[1]] + samps.m3$dic[[2]]
  
  select1_1_CACE[2+9*3] <- summary(samps.m3$samples)[[1]][1,1]  # mean CACE
  select1_1_CACE[(3+9*3):(5+9*3)] <- c(summary(samps.m3$samples)[[2]][1,1], 
                                       summary(samps.m3$samples)[[2]][1,3], 
                                       summary(samps.m3$samples)[[2]][1,5])  # 2.5% 50% 97.5% CACE
  select1_1_CACE[6+9*3] <- ifelse((select1_1_CACE[3+9*3]<=select1_1_CACE[1]) & (select1_1_CACE[5+9*3]>=select1_1_CACE[1]), 1, 0)
  select1_1_CACE[7+9*3] <- select1_1_CACE[5+9*3] - select1_1_CACE[3+9*3]  # CACE length
  select1_1_CACE[8+9*3] <- (select1_1_CACE[2+9*3] - select1_1_CACE[1])/select1_1_CACE[1]  # relative bias
  select1_1_CACE[9+9*3] <- select1_1_CACE[2+9*3] - select1_1_CACE[1]  # bias
  select1_1_CACE[10+9*3] <- (select1_1_CACE[2+9*3] - select1_1_CACE[1])^2  # bias^2
  
  write.table(select1_1_CACE, paste("sim_CACE/select1_1_CACE_", j, ".txt", sep=""), sep="\t")
  write.table(select1_1_pD, paste("sim_pD/select1_1_pD_", j, ".txt", sep=""), sep="\t")
  write.table(select1_1_DIC, paste("sim_DIC/select1_1_DIC_", j, ".txt", sep=""), sep="\t")

  output <- list(select1_1_pD, select1_1_DIC)
  return(output)
...
select1_1_DIC <- matrix(NA, R, 4)
select1_1_pD <- matrix(NA, R, 4)
select1_1_loc <- rep(NA, R)
select1_1_CACE <- matrix(NA, R, 37)
colnames(select1_1_CACE) <- 
...
for (i in 1:R){
  select1_1_DIC[i, ] <- read.table(paste("sim_DIC/select1_1_DIC_",i,".txt",sep=""))$x
  select1_1_loc[i] <- which.min(select1_1_DIC[i,])
  select1_1_pD[i, ] <- read.table(paste("sim_pD/select1_1_pD_",i,".txt",sep=""))$x
  
  select1_1_CACE[i, ] <- read.table(paste("sim_CACE/select1_1_CACE_",i,".txt",sep=""))$x
}

table1_1 <- matrix(NA, 1, 4)
for (i in 1:4) {
  table1_1[i] <- length(which(select1_1_loc == i)) 
}

selectCACE1_1 <- colMeans(select1_1_CACE)

# Save the data
write.table(table1_1, "simout/table1_1.txt", sep="\t", row.names = FALSE)
write.table(selectCACE1_1, "simout/selectCACE1_1.txt", sep="\t", row.names = FALSE)